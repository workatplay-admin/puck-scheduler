...
1. Each team must play the same number of games, ±1 (highest priority)  
...
**Note:** If divisions have unequal team counts, total games per division will differ. This is acceptable—per-team fairness takes priority over cross-division totals.
...
Button: "Export to CSV". Downloads file immediately with filename: hockey\_schedule\_YYYY-MM-DD.csv
